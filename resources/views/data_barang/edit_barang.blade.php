...
<!-- tampilan form add data -->
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Edit Barang
    </h1>
    <ol class="breadcrumb">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="/update_barang/{{$barang->id}}" method="POST">
            @method('patch')
            @csrf
            <div class="box-body">
             <div class="form-group">
                ...
                <div class="col-sm-5">
                   <select name="ukuran" class="form-control" autocomplete="off" id="ukuran_id">
                    ...
                    @foreach ($ukuran as $data)
                     <option {{$data->id == $barang->ukuran_id ? 'selected' : ''}} value="{{$data->id}}">{{$data->ukuran}}</option>
                     @endforeach
                   </select>
                </div>
              </div>
                ...
                <div class="col-sm-5">
                   <select name="tipe" class="form-control" autocomplete="off" id="tipe_id">
                    <option value="">--Pilih tipe barang--</option>
                     ...
                     <option {{$data->id == $barang->tipe_id ? 'selected' : ''}} value="{{$data->id}}">{{$data->tipe}}</option>
                     @endforeach
                ...
                <div class="col-sm-5">
                   <select name="warna" class="form-control" autocomplete="off" id="warna_id">
                    ...
                    @foreach ($warna as $data)
                     <option {{$data->id == $barang->warna_id ? 'selected' : ''}} value="{{$data->id}}">{{$data->warna}}</option>
                     @endforeach
                   </select>
                </div>
              </div> 
                ...
                <div class="col-sm-5">
                   <select name="agen" class="form-control" autocomplete="off" id="agen_id">
                    ...
                    @foreach ($agen as $data)
                     <option {{$data->id == $barang->agen_id ? 'selected' : ''}} value="{{$data->id}}">{{$data->agen}}</option>
                     @endforeach
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="harga_modal" autocomplete="off" required value="{{$barang->harga_modal}}">
                </div>
              </div>    
              ...
              <div class="form-group">
                ...
                <div class="col-sm-5">
                  <input type="text" class="form-control" name="harga_jual" autocomplete="off" required value="{{$barang->harga_jual}}">
                </div>
              </div>
