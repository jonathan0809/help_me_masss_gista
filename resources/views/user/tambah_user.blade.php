...
<!-- tampilan form add data -->
  ...
  <section class="content-header">
    <h1>
      <i class="fa fa-edit icon-title"></i> Tambah User
    </h1>
    <ol class="breadcrumb">
      <li><a href="?module=home"><i class="fa fa-home"></i> Beranda </a></li>
      <li><a href="?module=barang"> tambah user </a></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="box box-primary">
          <!-- form start -->
          <form role="form" class="form-horizontal" action="/tambah_user" method="POST">
          @csrf
            <div class="box-body">
